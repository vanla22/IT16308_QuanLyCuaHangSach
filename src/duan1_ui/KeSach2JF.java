 ...
 * @author Admin
 */
public class KeSach2JF extends javax.swing.JFrame {

    SachDAO sahdao = new SachDAO();
    int row = 0;

    /**
     * Creates new form KeSach2
     */
    public KeSach2JF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlDanhSachNV1, javax.swing.GroupLayout.PREFERRED_SIZE, 666, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlDanhSachNV1, javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KeSach2JF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void them() {
        ...
        for (int i = 0; i < row.length; i++) {
            sahdao.updateKeSach(KeSachhJF.maksStatic, tblSach.getValueAt(row[i], 0).toString());
        }
